...
isEmpty(obj) {
    ...
    render() {
        ...
        let currentGifts;
        if(givers.hasOwnProperty('items')){
...
<ul class="pagination" style={{display:"flex",float:"right"}}>
    ...
    {currentPage === last ? <li class="disabled"><a href="#! disabled"> Prev</a></li> :
    <li><a href="#!" style={{display:'flex'}}><span>Prev</span><i onClick={this.handleClick} id={prev} href={prev} class="material-icons">chevron_left </i></a>
    </li>
    }
    ...
    {    currentPage === last ? <li class="disabled">  <a href="#! disabled"> Next</a> </li>:
   <li> <a href="#!" style={{display:'flex'}}><i onClick={this.handleClick} id={pageNumbers[currentPage]} href={pageNumbers[currentPage]}class="material-icons">chevron_right </i><span>Next</span></a>
     </li>
    }
